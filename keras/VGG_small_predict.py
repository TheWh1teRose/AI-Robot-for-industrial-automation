...
model = keras.models.load_model('ckpts/LRCN_181_0.30.hdf5')
...
while True:
	...
	printscreen = cv2.resize(printscreen, dsize=(50, 50), interpolation=cv2.INTER_CUBIC)
	...
	if frames is None:
		frames = np.zeros((1,7,50,50,3), dtype=np.float32)
		for i in range(7):
			frames[0,i,...] = data
